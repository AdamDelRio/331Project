...
Based on the $R^{2}$ statistic we calculated for the model we fit, only `r model_fit`% of variability in the response values was accounted for by the regression model. 